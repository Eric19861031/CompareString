        ...
        for i in range(1, maxValue, 1):
            if self.sheet.cell(row=i, column=4).value == int(id):
                if self.sheet.cell(row=i, column=8).value is None:
                    str = self.sheet.cell(row=i, column=5).value
                else:
                    str = self.sheet.cell(row=i, column=8).value
        return str
        ...
        for i in range(1, maxValue, 1):
            if self.sheet.cell(row=i, column=4).value == int(id):
                if self.sheet.cell(row=i, column=9).value is None:
                    str = self.sheet.cell(row=i, column=6).value
                else:
                    str = self.sheet.cell(row=i, column=9).value
        return str
